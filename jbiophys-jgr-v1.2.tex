...
In the next example we go a step beyond to use persistent homology in order to compute the Betti number of the topological space of simplicial complexes. The idea is to study the sequence of complexes in the filtration. %can be transformed via homology into an inter-related family of evolving cycles.
