...
% n different graphs provide n diffrent scs
        \centering
        \includegraphics[height=2cm,keepaspectratio, width=0.8\linewidth]{../figures/fig2-sc}
...
\begin{figure}[h]
  %Figure 4 pacemaker coactivity (model generated not fMRI)
        \centering
        \includegraphics[height=2cm,keepaspectratio, width=0.5\linewidth]{../figures/figface}
...
%Persistence Homology focuses on the identification of the topological properties that remain invariant, for example disregard the micro level (noise) , PH is based on homology groupstwo shapes are similar if they are isomorphic equivalent, in other words datasets that can be deformed  and stretched into the same shape would fall into the same category. TDA allows noisy data to be addressed in a more efficient mannersimplicial complex: space triangulations by non overlapping polyhedra covering a topological space. SC "approximate" the object they are covering. Example of triangulations are Vorononoi, Delaunay , Vietoris and Czech.
